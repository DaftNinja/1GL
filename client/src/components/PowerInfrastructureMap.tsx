  ...
  return (
    <div className="relative w-full h-full flex" data-testid="power-infrastructure-map">
      ...
      <div className="flex-1 relative">
        ...
        {/* Signals panel — bottom center */}
        <div className="absolute bottom-14 left-1/2 -translate-x-1/2 z-[500] pointer-events-auto" data-testid="panel-signals">
          <div style={{
            ...
            <div style={{ display: "flex", gap: "12px", alignItems: "flex-end" }}>
              <button
                data-testid="signal-btn-price"
                onClick={() => setActiveSignal("price")}
                style={{
                  display: "flex", flexDirection: "column", alignItems: "center", gap: "6px",
                  background: activeSignal === "price" ? "rgba(255,255,255,0.10)" : "transparent",
                  border: activeSignal === "price" ? "1px solid rgba(255,255,255,0.22)" : "1px solid transparent",
                  borderRadius: "8px", padding: "6px 10px", cursor: "pointer",
                }}
              >
                <div style={{
                  width: "54px", height: "38px", borderRadius: "5px",
                  background: `linear-gradient(135deg, ${PRICE_STOPS.map(([, c]) => c).join(", ")})`,
                  border: activeSignal === "price" ? "2px solid rgba(255,255,255,0.6)" : "2px solid rgba(255,255,255,0.2)",
                }} />
                <span style={{ fontSize: "10px", color: activeSignal === "price" ? "#e2e8f0" : "#64748b", fontWeight: activeSignal === "price" ? 700 : 400 }}>
                  Electricity price
                </span>
              </button>
              <button
                data-testid="signal-btn-carbon"
                disabled
                title="Coming soon"
                style={{
                  display: "flex", flexDirection: "column", alignItems: "center", gap: "6px",
                  background: "transparent", border: "1px solid transparent",
                  borderRadius: "8px", padding: "6px 10px", cursor: "not-allowed", opacity: 0.35,
                }}
              >
                <div style={{
                  width: "54px", height: "38px", borderRadius: "5px",
                  background: "linear-gradient(135deg, #064e3b, #16a34a, #facc15, #ef4444)",
                  border: "2px solid rgba(255,255,255,0.15)",
                }} />
                <span style={{ fontSize: "10px", color: "#64748b" }}>Carbon intensity</span>
              </button>
              <button
                data-testid="signal-btn-renewable"
                disabled
                title="Coming soon"
                style={{
                  display: "flex", flexDirection: "column", alignItems: "center", gap: "6px",
              ...
              >
                ...
                <span style={{ fontSize: "10px", color: "#64748b" }}>Renewable mix</span>
              </button>
            </div>
          </div>
        </div>
